...
function openGate(){
  elGate.hidden = false;
  elGate.style.removeProperty('display');
...
function closeGate(){
  ...
  elGate.style.display = 'none'; // fallback
}
...
function startLiveUpdates(){
  if(supabase){
    try{ supabase.channel('scores-live').on('postgres_changes',{event:'INSERT',schema:'public',table:'scores'},()=>loadLeaderboards()).subscribe(); }
